...
use std::mem;
use crate::devices::util::sys::net as netsys;
...
fn create_sockaddr(ip_addr: stdnet::Ipv4Addr) -> netsys::sockaddr {
    ...
    let addr_in = netsys::sockaddr_in {
        sin_family: netsys::AF_INET as u16,
        sin_port: 0,
...
fn create_socket() -> Result<stdnet::UdpSocket> {
    ...
    Ok(unsafe { stdnet::UdpSocket::from_raw_fd(sock) })
}
