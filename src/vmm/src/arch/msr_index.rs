...
pub const MSR_MTR_RCAP: ::std::os::raw::c_uint = 0x000000fe;
...
pub const MSR_MTRR_FIX_64K_00000: ::std::os::raw::c_uint = 0x00000250;
pub const MSR_MTRR_FIX_16K_80000: ::std::os::raw::c_uint = 0x00000258;
pub const MSR_MTRR_FIX_16K_A0000: ::std::os::raw::c_uint = 0x00000259;
pub const MSR_MTRR_FIX_4K_C0000: ::std::os::raw::c_uint = 0x00000268;
pub const MSR_MTRR_FIX_4K_C8000: ::std::os::raw::c_uint = 0x00000269;
pub const MSR_MTRR_FIX_4K_D0000: ::std::os::raw::c_uint = 0x0000026a;
pub const MSR_MTRR_FIX_4K_D8000: ::std::os::raw::c_uint = 0x0000026b;
pub const MSR_MTRR_FIX_4K_E0000: ::std::os::raw::c_uint = 0x0000026c;
pub const MSR_MTRR_FIX_4K_E8000: ::std::os::raw::c_uint = 0x0000026d;
pub const MSR_MTRR_FIX_4K_F0000: ::std::os::raw::c_uint = 0x0000026e;
pub const MSR_MTRR_FIX_4K_F8000: ::std::os::raw::c_uint = 0x0000026f;
pub const MSR_MTRR_DEF_TYPE: ::std::os::raw::c_uint = 0x000002ff;
